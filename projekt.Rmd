...
```
Podatke o skokih na posameznih tekmah sem uvozil iz baze podatkov FIS-a v excel (ker so bili na voljo samo v formatu PDF) in potem iz xlsx v RStudio. Ostale podatke pa sem uvozil iz Wikipedije v obliki HTML.
